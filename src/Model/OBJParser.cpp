...
std::shared_ptr<Mesh> OBJParser::loadFromFile(std::string fileName) {
...
std::shared_ptr<Mesh> OBJParser::loadFromObjFile(std::string fileName) {
    std::ifstream file(fileName.c_str());
...
void OBJParser::genearateCodeFrmObj(std::string fileName) {
